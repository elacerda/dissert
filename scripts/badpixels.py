...
P = PCA.PCAlifa(fitsFile = '/home/lacerda/CALIFA/gal_fits/K0277/K0277_synthesis_eBR_v20_q036.d13c512.ps03.k2.mC.CCM.Bgsd61.fits', quantilQFlag = 0.95, lc = [3800, 6850])
...
plt.plot(K.l_obs[mask], K.f_obs[mask, 0] / K.fobs_norm[0])
plt.axhline(y = 0.05, color = 'r', lw = 1.0, ls = '--', label = '0.05 quantil')
plt.legend()
plt.savefig('badpix.pdf')
