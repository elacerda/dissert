...
P = PCA.PCAlifa(fitsFile = fitsfile, quantilQFlag = 0.9, lc = [3800,6850])
...
#ax2.plot(P.K.l_obs, f_obs_mask + 0.4 * mf, 'r')
#ax3.plot(P.K.l_obs, f_obs_maskEmLin + 0.8 * mf, 'b')
...
f.savefig('%s-constant_inital_mask-%d.%s' % (K.califaID, zone, outformat))
